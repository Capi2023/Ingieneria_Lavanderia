# Generated by Django 5.0.4 on 2024-05-20 03:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado', models.CharField(choices=[('EN', 'En espera'), ('AC', 'Aceptado'), ('TE', 'Terminado'), ('RE', 'Rechazado')], default='EN', max_length=2)),
